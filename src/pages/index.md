...
sections:
    ...
    features:
      ...
      - type: feature_item
        ...
        content: >
          ...
          kön och tider där extra personal kan bidra till en bättrekundupplevelse och mer försäljning.
  ...
  - section_id: contact-section
    title: Kontakta Oss
    content: >
      Uppgifter används endast i syfte att kontakta er, delas ej med tredje part
      utan medgivande. 
    background: gray
    form_id: contactForm
    hide_labels: false
